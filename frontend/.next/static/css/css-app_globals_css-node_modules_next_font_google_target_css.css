...
:root {
  ...
  --background-end-rgb: 255, 243, 224;
}
...
.hover\:bg-pizza-orange:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(255 87 34 / var(--tw-bg-opacity, 1));
}

.hover\:text-pizza-orange:hover {
  --tw-text-opacity: 1;
  color: rgb(255 87 34 / var(--tw-text-opacity, 1));
}
...
.focus\:ring-pizza-orange:focus {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(255 87 34 / var(--tw-ring-opacity, 1));
}
